...
<body style="font-family: Lato,Roboto,Arial,Helvetica,sans-serif; margin: 0; padding: 0; background:#000815;">
  ...
  <div class="d-flex justify-content-center text-white" style="background:#22223B;">
    <a href="index.php"> <button type="button" class="btn  text-white mr-1" style="width:186.95px; background:#22223B;">Online games</button></a>
    <a href="usergames.php"> <button type="button" class="btn  text-white" style="background:#3a3a66;">Games made by users</button></a>
...
<?php
        include 'config.php';
         $stmt= $db->prepare("SELECT * FROM usergames ORDER BY clicks DESC limit 5");
         $stmt->execute();
        ...
        <div class="d-flex bg-white mb-1" style="border-radius:.5rem; margin-left:5px;">
         ...
         <?php
            ...
            echo "<img src='usergameimages/" . $row['picture']."' width='70' height='56' style='border-radius:.5rem 0 0 .5rem;'>";?>
        ...
        <?php
              ...
              ?>
        <h6 class="mt-2 text-white text-center">New user added games:</h6>      
                 <?php
         $stmt= $db->prepare("SELECT * FROM usergames ORDER BY game_id DESC limit 5");
         $stmt->execute();
         while ($row = $stmt->fetch(PDO::FETCH_LAZY))
         {
        ?>
        ...
        <div class="card" style="width:11rem; height:100px;">
         ...
         <?php
            ...
            //Šeit izdrukā visas spēles no datubāzes
            echo "<img src='usergameimages/" . $row['picture']."' width='50' height='50';  class='card-img-top'>";?>
  ...
  <div class="container-fluid  d-flex flex-wrap" style="margin-top: 1.5rem;">
   <?php include 'downloadablegames.php'; 
   ?>
  </div>
</div>
</div>
