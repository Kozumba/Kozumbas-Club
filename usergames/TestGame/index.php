...
<div class="container-fluid mt-3">  
 <div class="card">
 <img class="card-img-top" src="../../usergameimages/Wildy.PNG">
 <div class="card-body text-center">
 <h1 class="card-title text-dark">Test Game</h1>
 <p class="card-text">This is a test description about this game</p>
 <a href="../TestGamegametest.zip" class="btn btn-primary">Download the game</a>
</div>
</div>
</div>
</body>
