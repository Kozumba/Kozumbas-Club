...
<div class="container-fluid mt-3">  
 ...
 <h1 class="card-title text-dark">Stunt Destroyer</h1>
 <p class="card-text">Stunt Destroyer is an online game where you’ll be controlling a race car. Your objective is to gain speed on a platform. After that, try to destroy as many obstacles as you can. You will get rewarded with money that can be used to upgrade your engine or your turbo. You can also use this money to buy a new car. Your main objective will be to get to the green box. This can be done only with an upgraded car. If you reach the green box, you continue to the next level!</p><iframe src="https://www.gameflare.com/embed/stunt-destroyer/" frameborder="0" scrolling="no" width="100%" height="685" allowfullscreen></iframe></div>
</div>
</div>
</body>
</html>