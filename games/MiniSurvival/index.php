...
<div class="container-fluid mt-3">  
 ...
 <h1 class="card-title text-dark">Mini Survival</h1>
 <p class="card-text">Mini Survival is a great mini game where you'll be trying to survive for as long as possible. You start barehanded, with your first objective being to collect a few stones, some wood and other resources that can be used to create your first tools. You can therefore create an axe, a fishing rod or something to attack with, a sword for instance. You can also start a fire that you'll be grateful for during the night. If you like gardening, you can start your own farm by planting seeds. You can also hunt animals. As you can see, the possibilities are endless, and you’ll be entertained for hours.</p><iframe src="https://www.gameflare.com/embed/mini-survival/" frameborder="0" scrolling="no" width="100%" height="635" allowfullscreen></iframe></div>
</div>
</div>
</body>
</html>