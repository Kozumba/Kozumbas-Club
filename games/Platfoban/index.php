...
<div class="container-fluid mt-3">  
 ...
 <h1 class="card-title text-dark">Platfoban</h1>
 <p class="card-text">Platfoban is a Sokoban-style puzzle game with a platforming element! You need to collect all the coins at every level. There are two modes in the game: the platforming mode, in which you can run and jump, and the Sokoban mode, in which you can move blocks, coins, etc. In Sokoban mode, chest monsters wake up, attack, and chase the main character. In platforming mode, chests sleep and can be used as platforms.</p><iframe src="https://wanted5games.com/games/html5/platfoban-new-en-s-iga-cloud/index.html?pub=10" name="cloudgames-com" width="100%" height="585" frameborder="0" scrolling="no"></iframe></div>
</div>
</div>
</body>
</html>