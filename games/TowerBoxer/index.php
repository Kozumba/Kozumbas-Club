...
<div class="container-fluid mt-3">  
 ...
 <h1 class="card-title text-dark">Tower Boxer</h1>
 <p class="card-text">A bunch of boxing champions challenged themselves to wreck a whole skyscraper with their fists! A rather crazy idea, are you willing to help out? Punch the tower from left or right to chop it down, but watch out for approaching balconies!</p><iframe src="https://wanted5games.com/games/html5/tower-boxer-new-en-s-iga-cloud/index.html?pub=10" name="cloudgames-com" width="100%" height="617" frameborder="0" scrolling="no"></iframe></div>
</div>
</div>
</body>
</html>