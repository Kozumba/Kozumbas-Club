...
<div class="container-fluid mt-3">  
 ...
 <h1 class="card-title text-dark">Bubble Shooter</h1>
 <p class="card-text">Play the classic and most addictive bubble pop game for FREE, match 3 colors and clear levels. Don’t miss out on this fun relaxing game! You need to aim & shoot, to drop & burst all bubbles.</p><iframe src="https://wanted5games.com/games/html5/bubble-shooter-1-new-en-s-iga-cloud/index.html?pub=10" name="cloudgames-com" width="100%" height="747" frameborder="0" scrolling="no"></iframe></div>
</div>
</div>
</body>
</html>