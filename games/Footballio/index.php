...
<div class="container-fluid mt-3">  
 ...
 <h1 class="card-title text-dark">Football.io</h1>
 <p class="card-text">Football.io is a football game with a difference. Rather than trying to kick a single ball into the opposition’s goal, the player must avoid a multitude of balls while collecting yellow ones. The yellow balls gives you various bonuses; some give a speed boost, some restore lost lives, some make you temporarily invincible. The bar at the bottom of the screen indicates how much of the power is left – but be quick, as it depletes fast. Players start with six health points, but can pick up more along the way. Move using the arrow keys Touchscreen players can use the on-screen joystick.</p><iframe src="https://wanted5games.com/games/html5/football-io-new-en-s-iga-cloud/index.html?pub=10" name="cloudgames-com" width="100%" height="480" frameborder="0" scrolling="no"></iframe></div>
</div>
</div>
</body>
</html>