...
<div class="container-fluid mt-3">  
 ...
 <h1 class="card-title text-dark">Mini Tennis 3D</h1>
 <p class="card-text">Mini Tennis 3D is a great online game for tennis fans. If you don’t want to deal with any settings, you can simply start playing right away. Your objective will be to win every match. You will then start ascending the leader boards and earning more diamonds. These can be spent in the menu and you can buy a new character with these. There is 27 characters in total, so you will be able to choose whichever you want. You can also earn the diamonds in bonus levels where a mini-game awaits. During the fight, you can find many different bonuses that you can pick up. You can expect pretty graphics and simple gameplay, so enjoy the game!</p><iframe src="https://www.gameflare.com/embed/mini-tennis-3d/" frameborder="0" scrolling="no" width="100%" height="635" allowfullscreen></iframe></div>
</div>
</div>
</body>
</html>