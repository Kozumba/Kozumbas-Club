...
<div class="container-fluid mt-3">  
 ...
 <h1 class="card-title text-dark">Brave Triangle</h1>
 <p class="card-text">This Brave Triangle was born for adventure, and he’s running off to find it! It’s a big world out there, filled with plenty of barriers. With quick reflexes and a little skill, however, you should be able to make it far in this arcade game. Slip your way through narrow gates as a futuristic beat pulses in the background. Dash left and right to avoid the walls. This heroic adventurer only knows one speed: full. If you even graze a wall, BOOM!</p><iframe width='100%' height='489' frameborder='0' scrolling='no' src='https://g.shtoss.com/brave-triangle/'></iframe></div>
</div>
</div>
</body>
</html>